...
import { TimeEstimationStep } from './TimeEstimationStep';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto overflow-x-hidden">
        <DialogTitle className="sr-only">{t('planning.title')}</DialogTitle>
        ...
        ) : currentPhase === 'conflicts' && totalConflicts > 0 ? (
